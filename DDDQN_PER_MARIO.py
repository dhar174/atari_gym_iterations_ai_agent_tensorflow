...
##env = retro.make(game='KidNikiRadicalNinja-Nes', record='.', use_restricted_actions = retro.Actions.DISCRETE)
num_actions = env.action_space.n
#env.use_restricted_actions = retro.Actions.DISCRETE
double_q=True
...
for i in range(num_episodes):
    ...
    while True:
        ...
        #action = env.action_to_array(action)
        #print(action)
